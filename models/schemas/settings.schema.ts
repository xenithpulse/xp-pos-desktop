...
const HubConfigSchema = new Schema<IHubConfig>(
  {
    ...
    defaultTab:           { type: String, enum: ['floor-plan', 'orders', 'order-editor', 'order-list', 'takeaway', 'delivery'], default: DEFAULT_SETTINGS.hub.defaultTab },
    ...
    showDelivery:         { type: Boolean, default: DEFAULT_SETTINGS.hub.showDelivery },
